...
def sin_source(amp=1., freq=1., phase=0.):
...
Cov = Covariances()
Coh = Coherences(fmin=1., fmax=40., fs=sfreq, coh="ordinary")
ImCoh = Coherences(fmin=1., fmax=40., fs=sfreq, coh="imaginary")
...
for dec_phase in p_space:
    ...
    imcoh_mats.append(nearestPD(preproc(ImCoh.fit_transform(eeg[np.newaxis, ...]).mean(axis=-1))[0]))
...
lcov = ax.plot(p_space, cov_d, label=r"$\delta(\mathrm{cov}_{\mathrm{ref}}, \mathrm{cov})$", color="C0")
ax2 = ax.twinx()
lcoh = ax2.plot(p_space, coh_d, label=r"$\delta(\mathrm{coh}_{\mathrm{ref}}, \mathrm{coh})$", color="C1")
limcoh = ax2.plot(p_space, imcoh_d, label=r"$\delta(\mathrm{imcoh}_{\mathrm{ref}}, \mathrm{imcoh})$", color="C2")
...
mpl.style.use("seaborn-muted")
fig, ax = plt.subplots(1, 1, figsize=(8, 6))
ax.plot(a_space, cov_d, label=r"$\delta(\mathrm{cov}_{\mathrm{ref}}, \mathrm{cov})$", color="C0")
ax.plot(a_space, coh_d, label=r"$\delta(\mathrm{coh}_{\mathrm{ref}}, \mathrm{coh})$", color="C1")
ax.plot(a_space, imcoh_d, label=r"$\delta(\mathrm{imcoh}_{\mathrm{ref}}, \mathrm{imcoh})$", color="C2")
...
mpl.style.use("seaborn-muted")
fig, ax = plt.subplots(1, 1, figsize=(8, 6))
ax.plot(f_space, cov_d, label=r"$\delta(\mathrm{cov}_{\mathrm{ref}}, \mathrm{cov})$", color="C0")
ax.plot(f_space, coh_d, label=r"$\delta(\mathrm{coh}_{\mathrm{ref}}, \mathrm{coh})$", color="C1")
ax.plot(f_space, imcoh_d, label=r"$\delta(\mathrm{imcoh}_{\mathrm{ref}}, \mathrm{imcoh})$", color="C2")
